      ...
      <div className="flex flex-col items-center justify-center">
        ...
        <div className="grid w-full justify-center md:grid-cols-2 gap-8 mt-11 md:mt-16">
          {ChooseCards.map((card) => (
            <div
              className="flex relative min-h-[350px] sm:min-h-[322px] flex-col h-full rounded-20 py-6 px-8 bg-dark-gold border border-dark-border"
              key={card.id}
            >
              <Image
                width={211}
              ...
              <div className="flex justify-between">
                <Image className="mt-4" height={78} width={78} src={card.logo} alt="logo" />
                <p className="text-white opacity-20 text-custom-6xl font-bold pe-4">{card.column}</p>
              </div>
